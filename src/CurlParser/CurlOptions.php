...
class CurlOptions
{
     ...
     * @throws Exception
     */
    public static function getDetailsForShortOptionName(string $shortOptionName): ?CurlOption
    {
        ...
        return self::getDetails($optionName);
    }

    /**
     * @throws Exception
     */
    public static function getDetails(string $optionName): ?CurlOption
    {
        ...
        if (!empty(self::$longOptionsDetails[$optionName]['processor'])) {
            $processorInstance = ProcessorBuilder::getProcessorByClassName(
                self::$longOptionsDetails[$optionName]['processor']
            );
        } else {
            $processorInstance = null;
        }

        return match (self::$longOptionsDetails[$optionName]['type']) {
            'bool' => new CurlBooleanOption(
                $optionName,
